...
<html>
<head>
<title>Toko klontong - Masuk</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : 082325452420</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Toko klontong</a></h1>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>universitas pelita bangsa</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="haryomadridista@email">info@email</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i> 082325452420</li>
					</ul>
				</div>
