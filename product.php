...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i> universitas bangsa</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="haryomadridsnta@email">info@email</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2021 universitas pelita bansga</p>
			</div>
		</div>
